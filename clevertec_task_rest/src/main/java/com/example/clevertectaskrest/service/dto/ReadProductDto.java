package com.example.clevertectaskrest.service.dto;
...
public class ReadProductDto {
    ...
    public ReadProductDto(Long id, String name, String manufacturer, LocalDateTime expirationDate, Integer weight, Integer cost, Long count) {
        this.id = id;
        this.name = name;
